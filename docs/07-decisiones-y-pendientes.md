...
| ✅  | **Cobros — Multas**                                 | Las multas generadas por no pago se cobran junto con el siguiente pago del cliente. El cobrador las registra en el mismo acto del cobro. En renovaciones no son obstáculo: por defecto se descuentan del desembolso, pero el gerente puede condonarlas a su juicio (con motivo obligatorio) al aprobar.       |
